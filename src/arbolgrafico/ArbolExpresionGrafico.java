...
public class ArbolExpresionGrafico extends JPanel 
{
 ...
 public ArbolExpresionGrafico( ArbodeExpresiones miArbol) 
    ...
    */
     private Dimension calcularTama�oSubarbol(Nodo1 n) 
    {
          if (n == null) 
              return new Dimension(0,0);
 
          Dimension ld = calcularTama�oSubarbol(n.getNodoIzquierdo());
          Dimension rd = calcularTama�oSubarbol(n.getNodoDerecho());
